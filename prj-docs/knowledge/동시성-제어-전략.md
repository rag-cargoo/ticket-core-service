...
> - 홀드/결제 라이프사이클 서비스:
>   - `src/main/java/com/ticketrush/domain/reservation/service/ReservationLifecycleService.java`
> - 만료 스케줄러:
...
> | 결제 대기 모델링 | 없음 (즉시 확정/취소 중심) | `holdExpiresAt` 기반 결제 대기 + 만료 복구 | `src/main/java/com/ticketrush/domain/reservation/service/ReservationLifecycleService.java` |
...
> | 재판매 대기열 연계 | 취소 시 대기열 승격 없음 | 취소 시 대기열 상위 1명 `ACTIVE` 승격 | `src/main/java/com/ticketrush/domain/reservation/service/ReservationLifecycleService.java` |
...
> - 정책 서비스:
>   - `src/main/java/com/ticketrush/domain/reservation/service/SalesPolicyService.java`
...
> | 선예매 등급 제어 | 미지원 | `presaleMinimumTier` 검증으로 선예매 접근 통제 | `src/main/java/com/ticketrush/domain/reservation/service/SalesPolicyService.java` |
...
> - 차단/조회 서비스:
>   - `src/main/java/com/ticketrush/domain/reservation/service/AbuseAuditService.java`
...
> | --- | --- | --- | --- |
> | 부정사용 차단 규칙 | 없음 | `rate`, `duplicate`, `device` 3종 차단 | `src/main/java/com/ticketrush/domain/reservation/service/AbuseAuditService.java` |
