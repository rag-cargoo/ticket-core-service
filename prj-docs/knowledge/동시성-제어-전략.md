...
## <span style="background-color: #ffebee; padding: 5px 10px; border-radius: 5px; color: #333;">Step 0: 문제 상황 (락 미적용)</span>
---
...
## <span style="background-color: #e3f2fd; padding: 5px 10px; border-radius: 5px; color: #333;">Step 1: 낙관적 락 (Optimistic Lock)</span>
---
...
## <span style="background-color: #e3f2fd; padding: 5px 10px; border-radius: 5px; color: #333;">Step 2: 비관적 락 (Pessimistic Lock)</span>
---
...
## <span style="background-color: #e8f5e9; padding: 5px 10px; border-radius: 5px; color: #333;">Step 3: Redis 분산 락 (Distributed Lock)</span>
---
...
## <span style="background-color: #e3f2fd; padding: 5px 10px; border-radius: 5px; color: #333;">Step 4: Kafka 기반 비동기 대기열 (Async Queue)</span>
---
...
## <span style="background-color: #e8f5e9; padding: 5px 10px; border-radius: 5px; color: #333;">Step 5: Redis Sorted Set 기반 실시간 대기열</span>
---
...
## <span style="background-color: #ffebee; padding: 5px 10px; border-radius: 5px; color: #333;">Step 6: 유입량 제어 전략 (Throttling)</span>
---
