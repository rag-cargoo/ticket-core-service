...
@WebMvcTest(
        ...
        properties = "app.frontend.u1-callback-url=https://ui.example.com/ux/u1/callback.html"
)
@AutoConfigureMockMvc(addFilters = false)
class SocialAuthCallbackRedirectControllerExternalUrlTest {
    ...
    @Test
    void callbackRoute_shouldRedirectToConfiguredAbsoluteU1CallbackWithOriginalQuery() throws Exception {
        mockMvc.perform(get("/login/oauth2/code/naver")
                        .param("code", "sample-code")
                        .param("state", "u1_naver_1770963678337_d4xmuaov06"))
                .andExpect(status().is3xxRedirection())
                .andExpect(redirectedUrlPattern("https://ui.example.com/ux/u1/callback.html?*"))
